...
>(({ className, variant = 'default', ...props }, ref) => {
  const variants = {
    ...
    underline:
      'inline-flex h-10 items-center justify-center gap-4 border-b text-muted-foreground',
  }
...
>(({ className, variant = 'default', ...props }, ref) => {
  const variants = {
    ...
    underline:
      'inline-flex items-center justify-center whitespace-nowrap pb-3 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-foreground data-[state=active]:border-b-2 data-[state=active]:border-primary',
  }
